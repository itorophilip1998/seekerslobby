            ...
            <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                <tr>
                    <td align="left" valign="top" class="desktop">
                        <h3 class="mail_header">Hello! {{$billPayment->user->name}}</h3>

                            <p style="font-size:15px !important;">You paid <span style="font-weight:bold;">&#8358;{{ number_format($billPayment->amount, 2) }}</span> for 
                            <span style="font-weight:bold;">{{$billPayment->type}}</span> using your Paddipay wallet..</p>
                            <br>
