            ...
            <table width="500" cellpadding="0" cellspacing="0" border="0" class="container">
                <tr>
                    <td align="left" valign="top" class="desktop">
                        <h3 class="mail_header" style="font-size:16px !important;">Hello! {{$investment->user->name}}</h3>
                            <p style="font-size:15px !important;">Congratulations! You have successfully invested in the <span style="font-weight:bold">{{$package->package_name}}</span>
                                package. Be rest assured that your investment will be due in 7 days. Your current wallet balance is: <span style="font-weight:bold;">&#8358;{{ number_format($investment->user->accounts->balance, 2) }}</span></p>
