    ...
    <header>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0 text-left text-lg-center">
            <li class="nav-item">
          ...
          <form class="form-inline my-2 my-lg-0 ">
            <nuxt-link to="/signin" class="btn btn-primary rounded-x text-white my-2 my-sm-0" type="button">Get Started</nuxt-link>
          </form>
        </div>
      </div>
    </nav>
